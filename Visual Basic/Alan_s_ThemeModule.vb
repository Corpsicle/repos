Friend Module Alan_s_ThemeModule
    Dim windowWidth, windowHeight, PenColour, color, namedColor, BackgroundColour, QuitButton, NextButton, CenterX, CenterY, Stp, Msg, I, S, rgbColor, rgb, nColor, colors, index, dmin, d, red, green, blue, hex, dec, min, level, brightness, gray, len, ptr As Primitive
    Sub Main()
        ' Alan's Theme.sb
        ...
        ' thanks for the colour routines just what i was looking for 😁
...
Start:
        ...
        Msg = "Alan's Theme        Stepping By : " + Stp + "        Colour:  " + PenColour
    ...
    Sub Initialize()
        ...
        GraphicsWindow.Width = 640 ' Size of Window we are using  1024 x 768 pixels 
        ...
        Colors_Init() ' Initialize the Colors Array with values
    ...
    Sub NearestNamedColor()
        ...
        nColor = Microsoft.SmallBasic.Library.Array.GetItemCount(colors) '- nColor holds the total number of named colors available in the colors array.
        index = Microsoft.SmallBasic.Library.Array.GetAllIndices(colors) '- index stores all indices of the colors array.
        dmin = 256 * Microsoft.SmallBasic.Library.Math.SquareRoot(3) '- dmin is initialized to a large value (the maximum possible Euclidean distance between colors).
        namedColor = ""
        For I = 1 To nColor
